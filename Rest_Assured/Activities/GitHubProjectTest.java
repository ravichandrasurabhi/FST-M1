...
public class GitHubProjectTest {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAIEWxDkDd9Xpg2AvwmsEc1ucbtYBuxQC+6aCY9jWwCV4t azuread\\ravisurabhi@IBM-PF3PE7AW";
    int sshKeyId;

    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "token ghp_o5gGODacXCjmjmoCaPnCflrqqf2938H8yy").
