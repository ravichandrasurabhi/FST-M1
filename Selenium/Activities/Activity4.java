...
public class Activity4 {
	public static void main(String args[]) {
     ...
     // Find the 3rd header and print its text
        ...
        String violetButtonClass = driver.findElement(By.cssSelector(".violet")).getAttribute("class");
        System.out.println(violetButtonClass);
        // Find the grey button and print its text
        String greyButtonText = driver.findElement(By.cssSelector(".grey")).getText();
